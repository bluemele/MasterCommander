...
(function() {
  ...
  const nodes = [
    ...
    { id:'commander',x:500, y:190, w:160, h:52, label:'Commander Unit', icon:'\ud83e\udde0', color:'#7c2d12', detail:'The brain on board. Raspberry Pi for charter fleets, Mac Mini M4 for private yachts. Monitors 24/7 and reaches you via app, WhatsApp, or the Master cloud dashboard.', tags:['Raspberry Pi','Mac Mini','24/7','Offline'] },
    ...
    { id:'master',   x:730, y:325, w:155, h:46, label:'Master (Cloud)',   icon:'\u2601\ufe0f', color:'#4c1d95', detail:'Included with charter fleet plans. Remote provisioning, OTA updates, fleet dashboard, historical analytics, and multi-boat management. Optional subscription for private yachts.', tags:['Fleet Mgmt','Dashboard','Analytics','OTA'] },
    ...
    { id:'aibrain',       x:570, y:350, w:125, h:42, label:'AI Brain',       icon:'\ud83e\udd16', color:'#374151', detail:'Charter fleets use cloud AI via internet \u2014 no local model needed. Private yachts run Qwen 14B locally on Mac Mini M4 \u2014 fully offline capable.', tags:['Cloud AI','Local AI','Qwen 14B','Offline'], sub:true },
  ];
